...
@pytest.mark.parametrize("login, password, expected_login_password, testparam", [("testit@testit.ru", "123", "testit@testit.ru_123"), ("testit2@testit.ru", "123", "testit2@testit.ru_123")])
